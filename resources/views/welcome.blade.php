...
<head>
    ...
    <title>swim-dash.com | Join, create your team and connect.</title>
...
> <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;"> <p>If you would like to contact swim-dash.com, click <a href="mailto:swimdash18@gmail.com">here.</a></p> <p class="pull-right">Copyright &copy; {{ date('Y') }} - swim-dash.com</p> </div> </div> <div class=bgimg-1> <div class=caption> {{-- <span class=border>COOL!</span> --}} </div> </div>
</body>
</html>
